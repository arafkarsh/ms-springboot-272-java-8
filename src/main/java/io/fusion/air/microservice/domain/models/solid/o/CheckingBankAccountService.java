 ...
 * @date:
 */
public class CheckingBankAccountService extends BankAccountBaseService {
     ...
     * @param _accountType
     */
    public CheckingBankAccountService(double _accountBalance, String _accountNumber, String _accountType) {
