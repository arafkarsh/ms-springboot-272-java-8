 ...
 * @date:
 */
public class FixedBankAccountService extends BankAccountBaseService {
     ...
     * @param _accountType
     */
    public FixedBankAccountService(double _accountBalance, String _accountNumber, String _accountType) {
