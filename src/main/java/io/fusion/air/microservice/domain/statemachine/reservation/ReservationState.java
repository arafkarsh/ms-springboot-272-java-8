...
public enum ReservationState {
    ...
    RENTAL_BOOKING_REQUEST(22),
    RENTAL_BOOKING_CONFIRMED(22),
    RENTAL_BOOKING_DECLINED(24),
    RENTAL_BOOKING_ROLLBACK(25),

    // FLIGHT BOOKING STATES
    FLIGHT_BOOKING_REQUEST(32),
    FLIGHT_BOOKING_CONFIRMED(33),
    FLIGHT_BOOKING_DECLINED(34),
    FLIGHT_BOOKING_ROLLBACK(35),
