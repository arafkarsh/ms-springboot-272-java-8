...
--
-- Name: country_m; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.country_m (
...
ALTER TABLE public.country_m OWNER TO postgres;
...
--
-- Data for Name: country_m; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.country_m (countryuuid, countrycode, countryid, countryname, countryofficialname) FROM stdin;
\.
...
b5a4fc93-3f51-4418-971a-08cf54a8aedf	john.doe	2023-06-25 19:24:55.854	john.doe	2023-06-25 19:24:55.854	t	0	Google Pixel 5 32 GB	12345	Google Pixel 5	35000.00
\.
...
--
-- Name: country_m country_m_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.country_m
